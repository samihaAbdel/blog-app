...
const ArticleCardSkelton = ({ className }) => {
  return (
    <div
      className={`rounded-xl overflow-hidden shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] ${className} animate-pulse`}
    >
      {/* image */}
...
export default ArticleCardSkelton;
